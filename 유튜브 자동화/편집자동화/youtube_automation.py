...
# =============================================
BASE_DIR = r"C:\Users\210830\Documents\coding\유튜브 자동화\편집자동화"
...
SUBTITLE_PADDING_X = 20                       # 배경 좌우 여백 (픽셀)
SUBTITLE_PADDING_Y = 12                       # 배경 상하 여백 (픽셀)
SUBTITLE_BOTTOM_MARGIN = 35                    # 하단 여백 (픽셀) - 줄일수록 아래로
# =============================================
...
def main():
    ...
    for seg in segments_info:
        ...
        video_path = os.path.join(VIDEOS_DIR, f"{image_num:02d}.mp4")
